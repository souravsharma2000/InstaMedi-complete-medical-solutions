<%@ Page Title="" Language="C#" MasterPageFile="~/Patient/Index.master" AutoEventWireup="true" CodeFile="PatientProfile.aspx.cs" Inherits="Patient_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="table table-bordered" align="centre">
        ...
        <tr>
            <td>
                <asp:GridView ID="GridView2" runat="server" class="table table-bordered" AutoGenerateColumns="False" DataSourceID="SqlDataSource2">
                    <Columns>
                        <asp:BoundField DataField="Id" HeaderText="Id" SortExpression="Id" InsertVisible="False" ReadOnly="True" />
                        <asp:BoundField DataField="Patientid" HeaderText="Patientid" SortExpression="Patientid" />
                        <asp:BoundField DataField="Mediciname" HeaderText="Mediciname" SortExpression="Mediciname" />

                    </Columns>
                </asp:GridView>
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:eclinicConnectionString %>" SelectCommand="SELECT [id], [patientid], [Mediciname] FROM [PatientMedicine] WHERE ([patientid] = @patientid)">
                    <SelectParameters>
                        <asp:SessionParameter Name="patientid" SessionField="userid" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
